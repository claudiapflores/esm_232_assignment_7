...
ggplot(tmp, aes(p12, pop20))+geom_point()+labs(x="Survivability of ages 0 to 1 ",y="pop after 20 years")
# graph for sub-adults (age 1-2)
ggplot(tmp, aes(p23, pop20))+geom_point()+labs(x="Survivability of ages 1 to 2",y="pop after 20 years")
```